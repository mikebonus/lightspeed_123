...
<b>1)</b> This application is based on <b>MVI</b> design architecture (<b>100% in Kotlin</b>). <br/>
...
<b>3)</b> This application features a detail screen for each of the list item. </br> 
...
<b>11) This application has a feature where the a randomly selected item goes to the bottom of the list (CLICK "RANDOM" BUTTON for reference).</b> </br> 
